...
This repository contains comprehensive engineering standards for guiding Claude Code, Codex, Cursor, and other AI Coding Agents. Core principles:
...
- Communicate in Chinese with user (unless user requests English)
- When uncertain, ask immediately rather than guess
- Progress reports: brief completion status after each milestone
